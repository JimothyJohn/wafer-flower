...
| **Halo Beveloid Pinion** | The parallel-axis mate: cone big-at-front, wall-side hub, N20 D-shaft bore. | Mate its axis **parallel** to the ring axis at the centre distance C the feature reports (325.5 mm at the shipped build), big end toward the viewer. |

Both features default to the shipped Rev B.3 numbers (N=9, Ri=255, bw=30,
module 5.6 nominal → 5.384 flush, face 4.5, PA 20°, straight teeth). Spiral
...
neighbour wafer's clearance plane; the gate computes ~4.83 mm at B.3).

## Crib sheet at Rev B.3

- 108T ring (12/segment), flush module **5.384** (5.6 nominal)
- Front radii: root 284.0, pitch 290.7, tip 296.1; wall = front × 1.0155
- Face 4.5 mm, cone 45°, straight (spiral 0°)
- 12T pinion, mid-face scale s_prof ≈ 1.0077, ratio 9:1, counter-rotating
- Centre distance **C = 325.5 mm**, pinion axis ∥ ring axis
